...
@class SBHomeScreenViewController; @class SBControlCenterController; @class SpringBoard; @class SBLockScreenViewControllerBase; @class PCSimpleTimer; 
...
static __attribute__((constructor)) void _logosLocalCtor_9bbb1b2d(int __unused argc, char __unused **argv, char __unused **envp) {
	@autoreleasepool {
        loadPrefs();
