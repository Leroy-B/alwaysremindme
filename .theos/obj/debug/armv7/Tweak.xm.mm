...
@class SpringBoard; @class SBHomeScreenViewController; @class PCSimpleTimer; @class SBLockScreenViewControllerBase; 
...
static __attribute__((constructor)) void _logosLocalCtor_dcc030d4(int __unused argc, char __unused **argv, char __unused **envp) {
	@autoreleasepool {
        loadPrefs();
